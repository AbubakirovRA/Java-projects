...
function ct_replace(){
    ct_repl('body *',/495.120.40.96/gi, "800 222-86-49" );
    ct_repl('body *',/\(495\) 120.40.96|\(800\) 500-05-22/gi, "(800) 222-86-49" );
    ct_repl('body *',/\( 800 \) 120.40.96/gi, "( 800 ) 222-86-49" );
    ct_repl_a('a[href*="1204096"],a[href*="120-40-96"],a[href*="5000522"], a[href*="500-05-22"]','href','tel:+78002228649');
}
ct_ready(ct_replace);window.calltouch_phone = "78002228649";            if (window['ct'] && typeof window['ct'] === 'function') {
                window['ct']('create_session', { sessionId: 3994882555, siteId: 19506, modId: '2cda0fc2', setCookie: true, endSessionTime: 1668505617, domain: 'skillbox.ru', setCtCookie: '200000002257184634', setLkCookie: null, denialTime: 0, phones: {"222444":{"subPoolName":"SEO \u044f\u043d\u0434\u0435\u043a\u0441 800","phoneId":"347587","phoneNumber":"78002228649","phoneCode":"800","phoneBody":"2228649"}}, ecommerceGa4Enabled: false, ecommerceTimeout: 250 });
                        } else {
              var xmlHttp = new XMLHttpRequest();
              xmlHttp.open( "GET", 'https://mod.calltouch.ru/set_attrs_by_get.php?siteId=19506&sessionId=3994882555&attrs={"clientError_NO_CT_CREATE_SESSION": 1}', true );
              xmlHttp.send( null );
            }
...
})(window, "ctw", {"siteId":19506,"sessionId":3994882555,"pageUrl":"https:\/\/skillbox.ru\/media\/code\/freymvork-spring-zachem-on-nuzhen-kak-ustroen-i-kak-rabotaet\/"})


        var call_value = '3994882555';
    var call_value_2cda0fc2 = call_value;
    if(window.onSessionCallValue) {
        onSessionCallValue('3994882555', '');
    }
