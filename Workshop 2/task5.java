...
* 7. Начиная с младшего разряда увеличиваем единицы в разрядах второго числа до 0.
* 8. На каждой итерации проверяем равенство. Если равенство верное - выдаем ответ, выходим из программы.
